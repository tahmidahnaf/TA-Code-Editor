...
function run() {
  ...
  try {document.querySelector(".console").contentWindow.eval(codeEditor.getValue()) }
  catch (e) { document.querySelector(".console").contentWindow.console.error(e.name + ": " + e.message) }
