...
codeEditor.setValue(`/*Alert function is disbled*/
`);
...
function run() {
  ...
  try { document.querySelector(".output").contentWindow.eval(codeEditor.getValue()); }
  catch (e) { document.querySelector(".output").contentWindow.console.error(e.name + ": " + e.message) }
